...
public class CustomizeOrder {
    public static void Customize(LinkedList<Customer> customerList,LinkedList<Customized> customizeList,LinkedList<Order> orderDataList,LinkedList<Style> styleList,LinkedList<Size> sizeList, LinkedList<Product> productList, LinkedList<Accessories> accessoriesList,LinkedList<Payment> paymentList,Staff staff){
   ...
   public static void ItemizedBill(int priority, LinkedList<Customized> customizeList, String date,double totalPrice){
   ...
   public static Customer SelectCustomer(LinkedList<Customer> customerList){
        String customer;
        Customer selectedcustomer = new Customer();
   ...
   public static void CreateCustomizedOrder(LinkedList<Customized> customizeList,LinkedList<Style> styleList,int style,LinkedList<Size> sizeList,int size,LinkedList<Product> productList,int product,LinkedList<Accessories> accessoriesList,int accessories,int priority){
   ...
   public static double CalculatePrice(LinkedList<Customized> customizeList,int priority){
   ...
   public static int SelectProduct(LinkedList<Product> productList){
   ...
   public static int SelectSize(LinkedList<Size> sizeList){
       Scanner scan = new Scanner(System.in);
       int size =0;
        System.out.println("\nSize Price List");
        System.out.println("***************************");
   ...
   public static int SelectStyle(LinkedList<Style> styleList){
       Scanner scan = new Scanner(System.in);
       int style =0;
       System.out.println("\nStyle Price List");
        System.out.println("***************************");
   ...
   public static int SelectAccessories(LinkedList<Accessories> accessoriesList){
        Scanner scan = new Scanner(System.in);
        int accessories  = 0;
